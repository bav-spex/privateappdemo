...
const Dashboard = () => {
  ...
  const tabs = [
    { id: '23', framework_name: 'Hippa' },
    { id: '24', framework_name: 'Cloud Security' },
    { id: '25', framework_name: 'PCI' }
  ]
      ...
      <div>
        <div style={{ marginBottom: '2vh', width: '24%', float: 'right', height: '720px', padding: '10px' }}>
          ...
          <Card sx={{ width: '100%', marginBottom: '2vh', height: '28%', backgroundColor: '#98BDFF' }}>
            <CardMedia component='img' height='150' image='/images/todo-icon.jpg' alt='Action Items' />
          ...
          <Card sx={{ width: '100%', marginBottom: '2vh', height: '23%', backgroundColor: '#98BDFF' }}>
            <CardContent>
              ...
              <Typography variant='body2'>7 policies are pending for appoval</Typography>
            </CardContent>
            <CardActions>
              <Button
                sx={{ color: 'white' }}
          ...
          <Card sx={{ width: '100%', marginBottom: '2vh', height: '23%', backgroundColor: '#98BDFF' }}>
            <CardContent>
              ...
              <Typography variant='body2'>10 with no mitigations/5 for review</Typography>
            </CardContent>
            <CardActions>
              <Button
                sx={{ color: 'white' }}
          ...
          <Card sx={{ width: '100%', marginBottom: '2vh', height: '23%', backgroundColor: '#98BDFF' }}>
            <CardContent>
              ...
              <Typography variant='body2'>56 audit findings are open</Typography>
            </CardContent>
            <CardActions>
              <Button
                sx={{ color: 'white' }}
          ...
          <Box sx={{ width: '100%' }}>
            <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
              <Tabs value={value} onChange={handleChange} aria-label='basic tabs example'>
                {tabs.map((item, index) => (
                  <Tab key={item.framework_name} label={item.framework_name} {...a11yProps(index)} />
                ))}
